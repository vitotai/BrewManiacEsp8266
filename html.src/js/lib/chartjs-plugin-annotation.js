    ...
    4: [function(require, module, exports) {
        ...
        module.exports = function(Chart) {
            ...
            var LineAnnotation = Chart.Element.extend({
                ...
                draw: function(ctx) {
                    ...
                    if (opt.label) {
                        ...
                        var textHeight = 12; // need to change it later
            ...
            function lineUpdate(obj, options, chartInstance) {
                ...
                if (isNaN(pixel)) {
                    if (options.value > scale.max) pixel = scale.getPixelForValue(scale.max);
                    else if (options.value < scale.min) pixel = scale.getPixelForValue(scale.min);
                }
